      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="container col-xs-12">
            ...
            <form class="well form-horizontal" action=" {{url('materiel/'. $materiel->id) }}" method="post"  id="contact_form">
                ...
                <legend><center><h2><b>Modifier Materiel</b></h2></center></legend><br>
                  ...
                  <div class="form-group ">
                        ...
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <input  name="libelle" class="form-control" type="text" value="{{ $materiel->libelle }}">
                          </div>
                        </div>
                  </div>  
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-9 inputGroupContainer">
                        <div style="width: 70%">
                          <textarea name="description" class="form-control" rows="3">{{ $materiel->description }}</textarea>
                        </div>
                      </div>
                  </div>
                        ...
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <select name="idCategorie" class="form-control select2">
                              <option value="{{$materiel->idCategorie}}"></option>
