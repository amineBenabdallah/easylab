...
@section('title','LRI | Modifier une Categorie')
      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="container col-xs-12">
            ...
            <form class="well form-horizontal" action=" {{url('categorie/'. $categorie->id) }}" method="post"  id="contact_form">
              <input type="hidden" name="_method" value="PUT">
            	{{ csrf_field() }}
              <fieldset>

                <!-- Form Name -->
                <legend><center><h2><b>Modifier Catégorie</b></h2></center></legend><br>

                  <div class="form-group ">
                        <label class="col-xs-3 control-label">Libelle</label>  
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <input  name="libelle" class="form-control" type="text" value="{{ $categorie->libelle }}">
                          </div>
                        </div>
                  </div>  
              ...
              <a href="{{ url('categorie')}}" class=" btn btn-lg btn-default"><i class="fa  fa-mail-reply"></i> &nbsp;Annuler</a>
