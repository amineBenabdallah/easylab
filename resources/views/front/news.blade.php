	...
	<body>
		...
		<div class="site-content">
					...
					<div class="header-bar">
						...
						<nav class="main-navigation">
							...
							<ul class="menu">
								...
								<li class="menu-item  current-menu-item"><a href="/news">Actualité</a></li>
			...
			<div class="page-head" data-bg-image="{{ URL::asset('images/cl.jpg') }}">
				<div class="container">
					<h2 class="page-title">Actualité</h2>
				</div>
			</div>
						...
						<div class="project-list">
							...
							<div class="project">
								<div class="project-content">
									<figure class="project-image"><img src="{{ URL::asset('images/'.$new->photo) }}" alt="Project"></figure>
									<h3 class="project-title">{{$new->titre}}</h3>
									<p>{{$new->date}}</p>
									<a href="{{url('news/'.$new->id)}}" class="button">Learn more</a>
								</div>
							</div>
							@endforeach
						</div>
