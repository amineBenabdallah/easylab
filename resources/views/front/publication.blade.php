				...
				<div class="fullwidth-block">
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<h2 class="section-title">{{$article->type}}</h2>
								<ul class="project-info">
									<li><strong>Date:</strong> {{$article->mois}} {{$article->annee}}</li>
									<li><strong>Lieu:</strong> {{$article->lieu_ville}} {{$article->lieu_pays}}</li>
									<li><strong>Team:</strong>
									 @foreach ($membres as $membre) 
									 {{$membre->name}} {{$membre->prenom}},
									 @endforeach
									</li>
									<li><strong>Résumé:</strong> {{$article->resume}}</li>
								</ul>
							</div>
						</div>
