				...
				<div class="fullwidth-block">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-6">
								<figure>
									<img src="{{ URL::asset('images/'.$new->photo) }}" alt="">
								</figure>
							</div>
							<div class="col-md-6">
								<h2 class="section-title">{{$new->titre}}</h2>
								<ul class="project-info">
									<li><strong>Date:</strong> {{$new->date}}</li>
									<li><strong>Type:</strong> {{$new->type}}</li>
									<li><strong>Lieu:</strong> {{$new->lieu}}</li>
									<li><strong>User:</strong> User</li>
									<li><strong>Détail:</strong> {{$new->detail}}</li>
								</ul>
							</div>
						</div>
