				...
				<div class="fullwidth-block">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-6">
								<figure>
									<img src="{{ URL::asset('images/pc.jpg') }}" alt="">
								</figure>
							</div>
							<div class="col-md-6">
								...
								<ul class="project-info">
									...
									<li><strong>Chef de projet:</strong> {{$projet->chef->name}} {{$projet->chef->prenom}}</li>
									@if($projet->partenaires)
									<li><strong>Partenaire:</strong> {{$projet->partenaires}}</li>
									@endif
									 @if($projet->lien)
									<li><strong>Partenaire:</strong> {{$projet->lien}}</li>
									@endif
									@if($projet->detail)
									<li><strong>Partenaire:</strong><a href="{{asset($projet->detail)}}">Lien fichier</a></li>
									@endif
									...
									<li><strong>Résumé:</strong> {{$projet->resume}}</li>
								</ul>
							</div>
						</div>
